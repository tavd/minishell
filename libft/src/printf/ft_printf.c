...
int	string_conversion(va_list args, char c)
{
	if (c == 'c')
		...
		return (printf_putnbr(va_arg(args, int), 10, 0, 0));
	else if (c == 'u')
		return (printf_putnbr(va_arg(args, int), 10, 1, 0));
	else if (c == 'x')
		return (printf_putnbr(va_arg(args, int), 16, 1, 1));
	else if (c == 'X')
		return (printf_putnbr(va_arg(args, int), 16, 1, 2));
	else if (c == 'p')
